    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 设备类别 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            // pageTotal
            api.get('/EquipmentCategory/GetBoCount',{}).then(x=>{
                this.pageTotal = x
            })
        },
        // 触发搜索按钮
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    api.del('/EquipmentCategory/Delete?id=' + row.id)
                        .then((res) => {
                            if (res.message == '删除成功') {
        ...
        delAllSelection() {
            ...
            api.post('/EquipmentCategory/Deletes', deleList).then((res) => {
        ...
        saveEdit() {
            ...
            api.post('/EquipmentCategory/update', this.form)
                .then((res) => {
